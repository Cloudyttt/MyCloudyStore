...
public class OptimizeAppAdapter extends RecyclerView.Adapter<OptimizeAppAdapter.ViewHolder>
{
    private List<AppInfo> optimizeAppList;
    ...
    public OptimizeAppAdapter(List<AppInfo> appInfoList)
    {
        optimizeAppList = appInfoList;
    }

    @Override
    public OptimizeAppAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_recommend_app,parent,false);
        OptimizeAppAdapter.ViewHolder holder = new OptimizeAppAdapter.ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(OptimizeAppAdapter.ViewHolder holder, int position)
    {
        AppInfo appInfo = optimizeAppList.get(position);
        ...
        AppInfo appInfo2 = optimizeAppList.get((position + 1) % 3);
        ...
        AppInfo appInfo3 = optimizeAppList.get((position + 2) % 3);
